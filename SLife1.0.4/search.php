...
<?php endif; ?>
<?php else : ?>
<h2 class="notfound">怎么找也没找到你想要的，换个关键字试试？或者用下面的标签来试试！</h2>
<div class="entry" style="margin:20px 30px;">
<p><?php wp_tag_cloud('smallest=15&largest=32&unit=pt&number=200&format=flat&orderby=name&order=ASC');?></p>
</div>
<?php endif; ?>
</div>
<?php get_sidebar(); ?>
