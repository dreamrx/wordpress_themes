...
<div class="link-entry">
	...
	<h1 class="post-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="鏈結">鏈結</a></h1>

	<div class="webshot">
		<div style="margin-left:36px;"><?php the_content(); ?></div>

<?php my_list_bookmarks('category_before=&category_after=&title_li=我的朋友&categorize=0&show_name=1&show_description=1&between= - - - '); ?>
