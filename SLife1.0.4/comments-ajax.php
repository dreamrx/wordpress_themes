...
?>
   ...
   <li <?php comment_class(); ?> id="comment-<?php comment_ID() ?>" style="background:#cacdcc;border:1px solid #a0a7a5">
     ...
     <div class="comment-author vcard">
       ...
       <?php } else { echo my_avatar($comment->comment_author_email, $size = '42', $default = get_bloginfo('template_directory'). '/images/default.jpg'); } ?>
